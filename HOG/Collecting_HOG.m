% This file computes the 3-D HoG descriptors for videos of a class and stores them in a folder named 'HOG'.
% Create a folder by name 'HOG'in the workspace before running the code.
